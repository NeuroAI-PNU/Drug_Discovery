...
class GLAM():
    ...
    def auto_blend(self, custom_dataset=None):
        ...
        self.glam_helper.blend_and_inference(custom_dataset=custom_dataset)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', type=str,
                        default='bbbp', help='bindingdb_c,  lit_esr1ant')
    parser.add_argument('--dataset_root', type=str, default='../../Dataset/GLAM-GP', help='./demo')

    parser.add_argument('--n_init_configs', default=1,
    ...
    parser.add_argument('--n_top_blend', default=1,
                        type=int, help='auto blend n models')
    parser.add_argument('--n_high_fidelity_seed', default=1,
    ...
    #parser.add_argument('--custom_dataset', default='tanimoto', type=str)

    args = parser.parse_args()
    args.n_init_configs, args.n_low_fidelity_seed, args.n_top_blend, args.n_high_fidelity_seed = 200, 3, 3, 5
    solver = GLAM(args)
    solver.low_fidelity_training()
    solver.auto_blend(custom_dataset="tanimoto")
    #solver.auto_blend(custom_dataset="ZINC40099027")