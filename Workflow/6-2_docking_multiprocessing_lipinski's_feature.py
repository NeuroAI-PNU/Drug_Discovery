...
def multiprocessing_smiles_to_pdbqt_0(data):
    for i in tqdm(range(1630), desc="pdbqt files translation..."):
        smiles_to_pdbqt(data["smiles"][i], f"./data/pdbqt_data/ligand_based_lipinski's_feature/ligand_{i}.pdbqt")

def multiprocessing_smiles_to_pdbqt_1(data):
    for i in tqdm(range(1630, 3260), desc="pdbqt files translation..."):
        smiles_to_pdbqt(data["smiles"][i], f"./data/pdbqt_data/ligand_based_lipinski's_feature/ligand_{i}.pdbqt")

def multiprocessing_smiles_to_pdbqt_2(data):
    for i in tqdm(range(3260, 4890), desc="pdbqt files translation..."):
        smiles_to_pdbqt(data["smiles"][i], f"./data/pdbqt_data/ligand_based_lipinski's_feature/ligand_{i}.pdbqt")

def multiprocessing_smiles_to_pdbqt_3(data):
    for i in tqdm(range(4890, 6520), desc="pdbqt files translation..."):
        smiles_to_pdbqt(data["smiles"][i], f"./data/pdbqt_data/ligand_based_lipinski's_feature/ligand_{i}.pdbqt")

def multiprocessing_smiles_to_pdbqt_4(data):
    for i in tqdm(range(6520, 8150), desc="pdbqt files translation..."):
        smiles_to_pdbqt(data["smiles"][i], f"./data/pdbqt_data/ligand_based_lipinski's_feature/ligand_{i}.pdbqt")

def multiprocessing_smiles_to_pdbqt_5(data):
    for i in tqdm(range(8150, 9780), desc="pdbqt files translation..."):
        smiles_to_pdbqt(data["smiles"][i], f"./data/pdbqt_data/ligand_based_lipinski's_feature/ligand_{i}.pdbqt")

def multiprocessing_smiles_to_pdbqt_6(data):
    for i in tqdm(range(9780, 11410), desc="pdbqt files translation..."):
        smiles_to_pdbqt(data["smiles"][i], f"./data/pdbqt_data/ligand_based_lipinski's_feature/ligand_{i}.pdbqt")

def multiprocessing_smiles_to_pdbqt_7(data):
    for i in tqdm(range(11410, 13040), desc="pdbqt files translation..."):
        smiles_to_pdbqt(data["smiles"][i], f"./data/pdbqt_data/ligand_based_lipinski's_feature/ligand_{i}.pdbqt")

def multiprocessing_smiles_to_pdbqt_8(data):
    for i in tqdm(range(13040, 14670), desc="pdbqt files translation..."):
        smiles_to_pdbqt(data["smiles"][i], f"./data/pdbqt_data/ligand_based_lipinski's_feature/ligand_{i}.pdbqt")

def multiprocessing_smiles_to_pdbqt_9(data):
    for i in tqdm(range(14670, 16300), desc="pdbqt files translation..."):
        smiles_to_pdbqt(data["smiles"][i], f"./data/pdbqt_data/ligand_based_lipinski's_feature/ligand_{i}.pdbqt")

def multiprocessing_smils_to_pdbqt_10(data):
    for i in tqdm(range(16300, 17930), desc="pdbqt files translation..."):
        smiles_to_pdbqt(data["smiles"][i], f"./data/pdbqt_data/ligand_based_lipinski's_feature/ligand_{i}.pdbqt")

def multiprocessing_smils_to_pdbqt_11(data):
    for i in tqdm(range(17930, 19560), desc="pdbqt files translation..."):
        smiles_to_pdbqt(data["smiles"][i], f"./data/pdbqt_data/ligand_based_lipinski's_feature/ligand_{i}.pdbqt")

def multiprocessing_smils_to_pdbqt_12(data):
    for i in tqdm(range(19560, 21190), desc="pdbqt files translation..."):
        smiles_to_pdbqt(data["smiles"][i], f"./data/pdbqt_data/ligand_based_lipinski's_feature/ligand_{i}.pdbqt")

def multiprocessing_smils_to_pdbqt_13(data):
    for i in tqdm(range(21190, 22820), desc="pdbqt files translation..."):
        smiles_to_pdbqt(data["smiles"][i], f"./data/pdbqt_data/ligand_based_lipinski's_feature/ligand_{i}.pdbqt")

def multiprocessing_smils_to_pdbqt_14(data):
    for i in tqdm(range(22820, 24450), desc="pdbqt files translation..."):
        smiles_to_pdbqt(data["smiles"][i], f"./data/pdbqt_data/ligand_based_lipinski's_feature/ligand_{i}.pdbqt")

def multiprocessing_smils_to_pdbqt_15(data):
    for i in tqdm(range(24450, 26080), desc="pdbqt files translation..."):
        smiles_to_pdbqt(data["smiles"][i], f"./data/pdbqt_data/ligand_based_lipinski's_feature/ligand_{i}.pdbqt")

def multiprocessing_smils_to_pdbqt_16(data):
    for i in tqdm(range(26080, 27710), desc="pdbqt files translation..."):
        smiles_to_pdbqt(data["smiles"][i], f"./data/pdbqt_data/ligand_based_lipinski's_feature/ligand_{i}.pdbqt")

def multiprocessing_smils_to_pdbqt_17(data):
    for i in tqdm(range(27710, 29340), desc="pdbqt files translation..."):
        smiles_to_pdbqt(data["smiles"][i], f"./data/pdbqt_data/ligand_based_lipinski's_feature/ligand_{i}.pdbqt")

def multiprocessing_smils_to_pdbqt_18(data):
    for i in tqdm(range(29340, 30970), desc="pdbqt files translation..."):
        smiles_to_pdbqt(data["smiles"][i], f"./data/pdbqt_data/ligand_based_lipinski's_feature/ligand_{i}.pdbqt")

def multiprocessing_smils_to_pdbqt_19(data):
    for i in tqdm(range(30970, 32600), desc="pdbqt files translation..."):
        smiles_to_pdbqt(data["smiles"][i], f"./data/pdbqt_data/ligand_based_lipinski's_feature/ligand_{i}.pdbqt")

def multiprocessing_smils_to_pdbqt_20(data):
    for i in tqdm(range(32600, 34230), desc="pdbqt files translation..."):
        smiles_to_pdbqt(data["smiles"][i], f"./data/pdbqt_data/ligand_based_lipinski's_feature/ligand_{i}.pdbqt")

def multiprocessing_smiles_to_pdbqt_21(data):
    for i in tqdm(range(34230, 35860), desc="pdbqt files translation..."):
        smiles_to_pdbqt(data["smiles"][i], f"./data/pdbqt_data/ligand_based_lipinski's_feature/ligand_{i}.pdbqt")

def multiprocessing_smiles_to_pdbqt_22(data):
    for i in tqdm(range(35860, 37490), desc="pdbqt files translation..."):
        smiles_to_pdbqt(data["smiles"][i], f"./data/pdbqt_data/ligand_based_lipinski's_feature/ligand_{i}.pdbqt")

def multiprocessing_smiles_to_pdbqt_23(data):
    for i in tqdm(range(37490, 39120), desc="pdbqt files translation..."):
        smiles_to_pdbqt(data["smiles"][i], f"./data/pdbqt_data/ligand_based_lipinski's_feature/ligand_{i}.pdbqt")

def multiprocessing_smiles_to_pdbqt_24(data):
    for i in tqdm(range(39120, 40750), desc="pdbqt files translation..."):
        smiles_to_pdbqt(data["smiles"][i], f"./data/pdbqt_data/ligand_based_lipinski's_feature/ligand_{i}.pdbqt")

def multiprocessing_smiles_to_pdbqt_25(data):
    for i in tqdm(range(40750, 42380), desc="pdbqt files translation..."):
        smiles_to_pdbqt(data["smiles"][i], f"./data/pdbqt_data/ligand_based_lipinski's_feature/ligand_{i}.pdbqt")

def multiprocessing_smiles_to_pdbqt_26(data):
    for i in tqdm(range(42380, 44005), desc="pdbqt files translation..."):
        smiles_to_pdbqt(data["smiles"][i], f"./data/pdbqt_data/ligand_based_lipinski's_feature/ligand_{i}.pdbqt")

def multiprocessing_smiles_to_pdbqt_27(data):
    for i in tqdm(range(44005, 45630), desc="pdbqt files translation..."):
        smiles_to_pdbqt(data["smiles"][i], f"./data/pdbqt_data/ligand_based_lipinski's_feature/ligand_{i}.pdbqt")

def multiprocessing_smiles_to_pdbqt_28(data):
    for i in tqdm(range(45630, 47255), desc="pdbqt files translation..."):
        smiles_to_pdbqt(data["smiles"][i], f"./data/pdbqt_data/ligand_based_lipinski's_feature/ligand_{i}.pdbqt")

def multiprocessing_smiles_to_pdbqt_29(data):
    for i in tqdm(range(47255, 48880), desc="pdbqt files translation..."):
        smiles_to_pdbqt(data["smiles"][i], f"./data/pdbqt_data/ligand_based_lipinski's_feature/ligand_{i}.pdbqt")

def multiprocessing_smiles_to_pdbqt_30(data):
    for i in tqdm(range(48880, 50505), desc="pdbqt files translation..."):
        smiles_to_pdbqt(data["smiles"][i], f"./data/pdbqt_data/ligand_based_lipinski's_feature/ligand_{i}.pdbqt")

def multiprocessing_smiles_to_pdbqt_31(data):
    for i in tqdm(range(50505, 52130), desc="pdbqt files translation..."):
        smiles_to_pdbqt(data["smiles"][i], f"./data/pdbqt_data/ligand_based_lipinski's_feature/ligand_{i}.pdbqt")

def multiprocessing_smiles_to_pdbqt_32(data):
    for i in tqdm(range(52130, 53755), desc="pdbqt files translation..."):
        smiles_to_pdbqt(data["smiles"][i], f"./data/pdbqt_data/ligand_based_lipinski's_feature/ligand_{i}.pdbqt")

def multiprocessing_smiles_to_pdbqt_33(data):
    for i in tqdm(range(53755, 55380), desc="pdbqt files translation..."):
        smiles_to_pdbqt(data["smiles"][i], f"./data/pdbqt_data/ligand_based_lipinski's_feature/ligand_{i}.pdbqt")

def multiprocessing_smiles_to_pdbqt_34(data):
    for i in tqdm(range(55380, 57005), desc="pdbqt files translation..."):
        smiles_to_pdbqt(data["smiles"][i], f"./data/pdbqt_data/ligand_based_lipinski's_feature/ligand_{i}.pdbqt")

def multiprocessing_smiles_to_pdbqt_35(data):
    for i in tqdm(range(57005, 58630), desc="pdbqt files translation..."):
        smiles_to_pdbqt(data["smiles"][i], f"./data/pdbqt_data/ligand_based_lipinski's_feature/ligand_{i}.pdbqt")

def multiprocessing_smiles_to_pdbqt_36(data):
    for i in tqdm(range(58630, 60255), desc="pdbqt files translation..."):
        smiles_to_pdbqt(data["smiles"][i], f"./data/pdbqt_data/ligand_based_lipinski's_feature/ligand_{i}.pdbqt")

def multiprocessing_smiles_to_pdbqt_37(data):
    for i in tqdm(range(60255, 61880), desc="pdbqt files translation..."):
        smiles_to_pdbqt(data["smiles"][i], f"./data/pdbqt_data/ligand_based_lipinski's_feature/ligand_{i}.pdbqt")

def multiprocessing_smiles_to_pdbqt_38(data):
    for i in tqdm(range(61880, 63505), desc="pdbqt files translation..."):
        smiles_to_pdbqt(data["smiles"][i], f"./data/pdbqt_data/ligand_based_lipinski's_feature/ligand_{i}.pdbqt")

def multiprocessing_smiles_to_pdbqt_39(data):
    for i in tqdm(range(63505, 65124), desc="pdbqt files translation..."):
        smiles_to_pdbqt(data["smiles"][i], f"./data/pdbqt_data/ligand_based_lipinski's_feature/ligand_{i}.pdbqt")
...
def multiprocessing_run_smina_0():
    ...
    for i in tqdm(range(1630), desc="docking..."):
        results = run_smina(
            f"./data/pdbqt_data/ligand_based_lipinski's_feature/ligand_{i}.pdbqt",
            "./data/pdbqt_data/protein_4_pdbqt",
            #f"docking_poses_{i}",
            pocket_center,
            pocket_size,
        )
...
def multiprocessing_run_smina_1():
    ...
    for i in tqdm(range(1630, 3260), desc="docking..."):
        results = run_smina(
            f"./data/pdbqt_data/ligand_based_lipinski's_feature/ligand_{i}.pdbqt",
            "./data/pdbqt_data/protein_4_pdbqt",
            #f"docking_poses_{i}",
...
def multiprocessing_run_smina_2():
    ...
    for i in tqdm(range(3260, 4890), desc="docking..."):
        results = run_smina(
            f"./data/pdbqt_data/ligand_based_lipinski's_feature/ligand_{i}.pdbqt",
            "./data/pdbqt_data/protein_4_pdbqt",
            #f"docking_poses_{i}",
...
def multiprocessing_run_smina_3():
    ...
    for i in tqdm(range(4890, 6520), desc="docking..."):
        results = run_smina(
            f"./data/pdbqt_data/ligand_based_lipinski's_feature/ligand_{i}.pdbqt",
            "./data/pdbqt_data/protein_4_pdbqt",
            #f"docking_poses_{i}",
...
def multiprocessing_run_smina_4():
    ...
    for i in tqdm(range(6520, 8150), desc="docking..."):
        results = run_smina(
            f"./data/pdbqt_data/ligand_based_lipinski's_feature/ligand_{i}.pdbqt",
            "./data/pdbqt_data/protein_4_pdbqt",
            #f"docking_poses_{i}",
...
def multiprocessing_run_smina_5():
    ...
    for i in tqdm(range(8150, 9780), desc="docking..."):
        results = run_smina(
            f"./data/pdbqt_data/ligand_based_lipinski's_feature/ligand_{i}.pdbqt",
            "./data/pdbqt_data/protein_4_pdbqt",
            #f"docking_poses_{i}",
...
def multiprocessing_run_smina_6():
    ...
    for i in tqdm(range(9780, 11410), desc="docking..."):
        results = run_smina(
            f"./data/pdbqt_data/ligand_based_lipinski's_feature/ligand_{i}.pdbqt",
            "./data/pdbqt_data/protein_4_pdbqt",
            #f"docking_poses_{i}",
...
def multiprocessing_run_smina_7():
    ...
    for i in tqdm(range(11410, 13040), desc="docking..."):
        results = run_smina(
            f"./data/pdbqt_data/ligand_based_lipinski's_feature/ligand_{i}.pdbqt",
            "./data/pdbqt_data/protein_4_pdbqt",
            #f"docking_poses_{i}",
...
def multiprocessing_run_smina_8():
    ...
    for i in tqdm(range(13040, 14670), desc="docking..."):
        results = run_smina(
            f"./data/pdbqt_data/ligand_based_lipinski's_feature/ligand_{i}.pdbqt",
            "./data/pdbqt_data/protein_4_pdbqt",
            #f"docking_poses_{i}",
...
def multiprocessing_run_smina_9():
    ...
    for i in tqdm(range(14670, 16300), desc="docking..."):
        results = run_smina(
            f"./data/pdbqt_data/ligand_based_lipinski's_feature/ligand_{i}.pdbqt",
            "./data/pdbqt_data/protein_4_pdbqt",
            #f"docking_poses_{i}",
...
def multiprocessing_run_smina_10():
    ...
    for i in tqdm(range(16300, 17930), desc="docking..."):
        results = run_smina(
            f"./data/pdbqt_data/ligand_based_lipinski's_feature/ligand_{i}.pdbqt",
            "./data/pdbqt_data/protein_4_pdbqt",
            #f"docking_poses_{i}",
...
def multiprocessing_run_smina_11():
    ...
    for i in tqdm(range(17930, 19560), desc="docking..."):
        results = run_smina(
            f"./data/pdbqt_data/ligand_based_lipinski's_feature/ligand_{i}.pdbqt",
            "./data/pdbqt_data/protein_4_pdbqt",
            #f"docking_poses_{i}",
...
def multiprocessing_run_smina_12():
    ...
    for i in tqdm(range(19560, 21190), desc="docking..."):
        results = run_smina(
            f"./data/pdbqt_data/ligand_based_lipinski's_feature/ligand_{i}.pdbqt",
            "./data/pdbqt_data/protein_4_pdbqt",
            #f"docking_poses_{i}",
...
def multiprocessing_run_smina_13():
    ...
    for i in tqdm(range(21190, 22820), desc="docking..."):
        results = run_smina(
            f"./data/pdbqt_data/ligand_based_lipinski's_feature/ligand_{i}.pdbqt",
            "./data/pdbqt_data/protein_4_pdbqt",
            #f"docking_poses_{i}",
...
def multiprocessing_run_smina_14():
    ...
    for i in tqdm(range(22820, 24450), desc="docking..."):
        results = run_smina(
            f"./data/pdbqt_data/ligand_based_lipinski's_feature/ligand_{i}.pdbqt",
            "./data/pdbqt_data/protein_4_pdbqt",
            #f"docking_poses_{i}",
...
def multiprocessing_run_smina_15():
    ...
    for i in tqdm(range(24450, 26080), desc="docking..."):
        results = run_smina(
            f"./data/pdbqt_data/ligand_based_lipinski's_feature/ligand_{i}.pdbqt",
            "./data/pdbqt_data/protein_4_pdbqt",
            #f"docking_poses_{i}",
...
def multiprocessing_run_smina_16():
    ...
    for i in tqdm(range(26080, 27710), desc="docking..."):
        results = run_smina(
            f"./data/pdbqt_data/ligand_based_lipinski's_feature/ligand_{i}.pdbqt",
            "./data/pdbqt_data/protein_4_pdbqt",
            #f"docking_poses_{i}",
...
def multiprocessing_run_smina_17():
    ...
    for i in tqdm(range(27710, 29340), desc="docking..."):
        results = run_smina(
            f"./data/pdbqt_data/ligand_based_lipinski's_feature/ligand_{i}.pdbqt",
            "./data/pdbqt_data/protein_4_pdbqt",
            #f"docking_poses_{i}",
...
def multiprocessing_run_smina_18():
    ...
    for i in tqdm(range(29340, 30970), desc="docking..."):
        results = run_smina(
            f"./data/pdbqt_data/ligand_based_lipinski's_feature/ligand_{i}.pdbqt",
            "./data/pdbqt_data/protein_4_pdbqt",
            #f"docking_poses_{i}",
...
def multiprocessing_run_smina_19():
    ...
    for i in tqdm(range(30970, 32600), desc="docking..."):
        results = run_smina(
            f"./data/pdbqt_data/ligand_based_lipinski's_feature/ligand_{i}.pdbqt",
            "./data/pdbqt_data/protein_4_pdbqt",
            #f"docking_poses_{i}",
...
def multiprocessing_run_smina_20():
    ...
    for i in tqdm(range(32600, 34230), desc="docking..."):
        results = run_smina(
            f"./data/pdbqt_data/ligand_based_lipinski's_feature/ligand_{i}.pdbqt",
            "./data/pdbqt_data/protein_4_pdbqt",
            #f"docking_poses_{i}",
...
def multiprocessing_run_smina_21():
    ...
    for i in tqdm(range(34230, 35860), desc="docking..."):
        results = run_smina(
            f"./data/pdbqt_data/ligand_based_lipinski's_feature/ligand_{i}.pdbqt",
            "./data/pdbqt_data/protein_4_pdbqt",
            #f"docking_poses_{i}",
...
def multiprocessing_run_smina_22():
    ...
    for i in tqdm(range(35860, 37490), desc="docking..."):
        results = run_smina(
            f"./data/pdbqt_data/ligand_based_lipinski's_feature/ligand_{i}.pdbqt",
            "./data/pdbqt_data/protein_4_pdbqt",
            #f"docking_poses_{i}",
...
def multiprocessing_run_smina_23():
    ...
    for i in tqdm(range(37490, 39120), desc="docking..."):
        results = run_smina(
            f"./data/pdbqt_data/ligand_based_lipinski's_feature/ligand_{i}.pdbqt",
            "./data/pdbqt_data/protein_4_pdbqt",
            #f"docking_poses_{i}",
...
def multiprocessing_run_smina_24():
    ...
    for i in tqdm(range(39120, 40750), desc="docking..."):
        results = run_smina(
            f"./data/pdbqt_data/ligand_based_lipinski's_feature/ligand_{i}.pdbqt",
            "./data/pdbqt_data/protein_4_pdbqt",
            #f"docking_poses_{i}",
...
def multiprocessing_run_smina_25():
    ...
    for i in tqdm(range(40750, 42380), desc="docking..."):
        results = run_smina(
            f"./data/pdbqt_data/ligand_based_lipinski's_feature/ligand_{i}.pdbqt",
            "./data/pdbqt_data/protein_4_pdbqt",
            #f"docking_poses_{i}",
...
def multiprocessing_run_smina_26():
    ...
    for i in tqdm(range(42380, 44005), desc="docking..."):
        results = run_smina(
            f"./data/pdbqt_data/ligand_based_lipinski's_feature/ligand_{i}.pdbqt",
            "./data/pdbqt_data/protein_4_pdbqt",
            #f"docking_poses_{i}",
...
def multiprocessing_run_smina_27():
    ...
    for i in tqdm(range(44005, 45630), desc="docking..."):
        results = run_smina(
            f"./data/pdbqt_data/ligand_based_lipinski's_feature/ligand_{i}.pdbqt",
            "./data/pdbqt_data/protein_4_pdbqt",
            #f"docking_poses_{i}",
...
def multiprocessing_run_smina_28():
    ...
    for i in tqdm(range(45630, 47255), desc="docking..."):
        results = run_smina(
            f"./data/pdbqt_data/ligand_based_lipinski's_feature/ligand_{i}.pdbqt",
            "./data/pdbqt_data/protein_4_pdbqt",
            #f"docking_poses_{i}",
...
def multiprocessing_run_smina_29():
    ...
    for i in tqdm(range(47255, 48880), desc="docking..."):
        results = run_smina(
            f"./data/pdbqt_data/ligand_based_lipinski's_feature/ligand_{i}.pdbqt",
            "./data/pdbqt_data/protein_4_pdbqt",
            #f"docking_poses_{i}",
...
def multiprocessing_run_smina_30():
    ...
    for i in tqdm(range(48880, 50505), desc="docking..."):
        results = run_smina(
            f"./data/pdbqt_data/ligand_based_lipinski's_feature/ligand_{i}.pdbqt",
            "./data/pdbqt_data/protein_4_pdbqt",
            #f"docking_poses_{i}",
...
def multiprocessing_run_smina_31():
    ...
    for i in tqdm(range(50505, 52130), desc="docking..."):
        results = run_smina(
            f"./data/pdbqt_data/ligand_based_lipinski's_feature/ligand_{i}.pdbqt",
            "./data/pdbqt_data/protein_4_pdbqt",
            #f"docking_poses_{i}",
...
def multiprocessing_run_smina_32():
    ...
    for i in tqdm(range(52130, 53755), desc="docking..."):
        results = run_smina(
            f"./data/pdbqt_data/ligand_based_lipinski's_feature/ligand_{i}.pdbqt",
            "./data/pdbqt_data/protein_4_pdbqt",
            #f"docking_poses_{i}",
...
def multiprocessing_run_smina_33():
    ...
    for i in tqdm(range(53755, 55380), desc="docking..."):
        results = run_smina(
            f"./data/pdbqt_data/ligand_based_lipinski's_feature/ligand_{i}.pdbqt",
            "./data/pdbqt_data/protein_4_pdbqt",
            #f"docking_poses_{i}",
...
def multiprocessing_run_smina_34():
    ...
    for i in tqdm(range(55380, 57005), desc="docking..."):
        results = run_smina(
            f"./data/pdbqt_data/ligand_based_lipinski's_feature/ligand_{i}.pdbqt",
            "./data/pdbqt_data/protein_4_pdbqt",
            #f"docking_poses_{i}",
...
def multiprocessing_run_smina_35():
    ...
    for i in tqdm(range(57005, 58630), desc="docking..."):
        results = run_smina(
            f"./data/pdbqt_data/ligand_based_lipinski's_feature/ligand_{i}.pdbqt",
            "./data/pdbqt_data/protein_4_pdbqt",
            #f"docking_poses_{i}",
...
def multiprocessing_run_smina_36():
    ...
    for i in tqdm(range(58630, 60255), desc="docking..."):
        results = run_smina(
            f"./data/pdbqt_data/ligand_based_lipinski's_feature/ligand_{i}.pdbqt",
            "./data/pdbqt_data/protein_4_pdbqt",
            #f"docking_poses_{i}",
...
def multiprocessing_run_smina_37():
    ...
    for i in tqdm(range(60255, 61880), desc="docking..."):
        results = run_smina(
            f"./data/pdbqt_data/ligand_based_lipinski's_feature/ligand_{i}.pdbqt",
            "./data/pdbqt_data/protein_4_pdbqt",
            #f"docking_poses_{i}",
...
def multiprocessing_run_smina_38():
    ...
    for i in tqdm(range(61880, 63505), desc="docking..."):
        results = run_smina(
            f"./data/pdbqt_data/ligand_based_lipinski's_feature/ligand_{i}.pdbqt",
            "./data/pdbqt_data/protein_4_pdbqt",
            #f"docking_poses_{i}",
...
def multiprocessing_run_smina_39():
    ...
    for i in tqdm(range(63505, 65124), desc="docking..."):
        results = run_smina(
            f"./data/pdbqt_data/ligand_based_lipinski's_feature/ligand_{i}.pdbqt",
            "./data/pdbqt_data/protein_4_pdbqt",
            #f"docking_poses_{i}",
...
if __name__ == "__main__":
    ...
    data = pd.read_csv("./data/cluster_data_with_smiles.csv", low_memory=False)
